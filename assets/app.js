(function () {
  ...
  const lessons = [
    ...
    ['04-01', '4-1 Bot 資料流與部署架構', 'chapters/04-01.html', '進階篇', 'LINE Webhook Vercel Sheets Gmail'],
    ['04-02', '4-2 LINE Official Account 設定', 'chapters/04-02.html', '進階篇', 'Messaging API Channel Secret Access Token Webhook'],
    ['04-03', '4-3 Google Sheets 與 Gmail 設定', 'chapters/04-03.html', '進階篇', 'Google Sheets 服務帳號 Gmail App Password'],
    ['05-01', '5-1 設定環境變數', 'chapters/05-01.html', '進階篇', '程式碼 Vercel Environment Variables'],
    ['05-02', '5-2 部署、Webhook 與驗證', 'chapters/05-02.html', '進階篇', 'Vercel HTTPS Webhook URL Verify'],
    ['06-01', '6-1 groupId 與收件信箱分流', 'chapters/06-01.html', '進階篇', '多聊天室 groupId 分流 寄送'],
    ['06-02', '6-2 完整測試與常見錯誤排除', 'chapters/06-02.html', '進階篇', '完整測試 排錯 ChatGPT Drive Gmail']
  ];
